...
public class ClassSelect extends JFrame{
	...
	public ClassSelect (String title,String pokemonTrainer) {
		...
		lblSw = new JLabel("kabikon");
		lblAr = new JLabel("pikachu");
		lblAs = new JLabel("Raichu");
		btnSw.setIcon(new ImageIcon("images/Kabikon.jpg"));
		btnSw.setPreferredSize(new Dimension(200,300));
		btnAr.setIcon(new ImageIcon("images/Pikachu.jpg"));
		btnAr.setPreferredSize(new Dimension(200,300));
		btnAs.setIcon(new ImageIcon("images/Raichu.png"));
	...
	private class ButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
				...
				if(e.getSource()==btnSw){
					n=guiParser.selectCharacter("Kabikon");
				}
				else if(e.getSource()==btnAr){
					n=guiParser.selectCharacter("Pikachu");
				}
				else if(e.getSource()==btnAs){
					n=guiParser.selectCharacter("Raichu");
				}
